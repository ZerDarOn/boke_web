          ...
          <div className="bg-white dark:bg-[#1a1a1a] rounded-xl border border-gray-200 dark:border-white/10 p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <ReactMarkdown
                ...
                components={{
                  h1: ({children}) => (
                    <h1 className="text-3xl md:text-4xl font-serif font-bold text-ink dark:text-white mt-8 mb-4 pb-2 border-b-2 border-neon/30">
                      {children}
                    </h1>
                  ),
                  h2: ({children}) => (
                    <h2 className="text-2xl md:text-3xl font-serif font-bold text-ink dark:text-white mt-6 mb-3 pb-2 border-b border-gray-200 dark:border-white/10">
                      {children}
                    </h2>
                  ),
                  h3: ({children}) => (
                    <h3 className="text-xl md:text-2xl font-serif font-bold text-ink dark:text-white mt-5 mb-2">
                      {children}
                    </h3>
                  ),
                  p: ({children}) => (
