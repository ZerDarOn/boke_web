    ...
    <div className="w-full p-2 md:p-6 bg-gray-50 dark:bg-white/5 rounded-xl">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-min">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50 dark:bg-white/5 p-6 rounded-lg">
                    ...
                    <div className="flex items-center gap-1 text-[10px] text-green-600 font-mono">
                        <ArrowUpRight size={10} /> +23.1% {t.THIS_MONTH}
                    </div>
                </div>
                <div className="bg-gray-50 dark:bg-white/5 p-6 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1 text-[10px] text-green-600 font-mono">
                        <ArrowUpRight size={10} /> +18.7% {t.THIS_MONTH}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-4 grid grid-cols-1 md:grid-cols-3 gap-4">
             {[
                 { label: t.TOTAL_ALBUMS, count: '12', icon: Image },
                 { label: t.PHOTOS_STORED, count: '1,024', icon: Camera },
                 { label: t.DIARY_ENTRIES_LABEL, count: '365', icon: Book },
             ].map((asset, idx) => (
        ...
        <div className="col-span-1 md:col-span-1 lg:col-span-2 bg-white dark:bg-[#0a0a0a] p-6 border border-gray-200 dark:border-white/10 shadow-sm relative overflow-hidden group hover:border-neon/50 transition-colors rounded-lg">
            ...
            <div className="flex items-center gap-8">
                ...
                <div className="flex-1 space-y-2">
                    {[
                        { label: t.LABEL_ARTICLE, count: BLOG_POSTS.length, color: 'bg-neon' },
                        { label: t.LABEL_DIARY, count: DIARY_ENTRIES.length, color: 'bg-pink-400' },
                        { label: t.LABEL_GALLERY, count: GALLERY_ALBUMS.length, color: 'bg-amber-500' },
                        { label: t.LABEL_ANIME, count: ANIME_LIST.length, color: 'bg-purple-500' },
                    ].map((item, idx) => (
        ...
        <div className="col-span-1 md:col-span-1 lg:col-span-2 bg-white dark:bg-[#0a0a0a] p-6 border border-gray-200 dark:border-white/10 shadow-sm relative overflow-hidden group hover:border-neon/50 transition-colors rounded-lg">
            ...
            <div className="flex items-center gap-8">
                ...
                <div className="flex-1 space-y-2">
                    {[
                        { label: t.POST_COMMENTS, count: 856, color: 'bg-neon' },
                        { label: t.ANIME_COMMENTS, count: 234, color: 'bg-pink-400' },
                        { label: t.GALLERY_COMMENTS, count: 157, color: 'bg-amber-500' },
                    ].map((item, idx) => (
                        <div key={idx} className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                <div className={`w-2 h-2 rounded-full ${item.color}`}></div>
